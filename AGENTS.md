...
- Build: `./build.sh`. Test: `./test.sh` (83 assertions incl. EdDSA-verify-against-jwks, headless+form login, redirect_uri token check, nonce/kid/name claims). Keep green.
